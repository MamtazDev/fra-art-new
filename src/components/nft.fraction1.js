            ...
            <Link to={`/marketplace/details/${item.fraction.address}`}>
                <div className="card nft-items rounded-md shadow overflow-hidden mb-1 p-3">
                        ...
                        <div className="img-group">
                            <div className="user-avatar">
                                <span className="badge badge-link bg-dark2">
                                    ...
                                    <span style={{ marginLeft: 10, fontWeight: 600 }}>{item.holders.length}</span>
                                </span>
                            </div>
                        </div>
                    ...
                    <div className="nft-image rounded-md mt-3 position-relative overflow-hidden">
                        ...
                        <img src={item.item.mainData} className="img-fluid" alt="" style={{ height: 250, width: '100%' }} />
                    ...
                    <div className="card-body content position-relative p-0 mt-3">
                        ...
                        <div className='text-dark' style={{ fontSize: 14, fontWeight: 'bold' }}>Balance: {balance} {item.fraction.symbol}</div>
                        <hr />
                        <div style={{ textAlign: 'center' }}>
                            <div className='d-flex' style={{ alignItems: 'center' }}>
                                <div className='text-dark' style={{ fontSize: 12, paddingRight: 5 }}>Ownership</div>
                                <div className="progress" style={{ width: '100%' }}>
                                    <div className="progress-bar" role="progressbar" style={{ width: `${ownership}%` }} aria-valuenow={`${ownership}`} aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <div className='text-dark' style={{ fontSize: 12, paddingLeft: 5 }}>{ownership}%</div>
                            </div>
