...
const Home = (props) => {
  ...
  const fetchPopularCols = () => {
    let url =
      "https://api.reservoir.tools/collections/v5?sortBy=allTimeVolume&limit=3";
    let header = {
      accept: "*/*",
      "x-api-key": "377bd80c-5f8e-55ad-b3e2-0b141b62222f",
    };
    axios
      .get(url, header)
      .then((res) => {
  ...
  return (
    <>
      ...
      <section className="section">
        ...
        {/* Live Auction */}
        <div className="container mt-4 pt-2 mt-lg-5 pt-lg-0">
          <div className="row align-items-end mb-4 pb-2">
            <div className="col-md-8">
              <div className="section-title">
                <h4 className="title mb-2">Live Auctions</h4>
                {/* <h4 className="title mb-2">{t("hello")} Auctions</h4> */}
                <p className="text-muted mb-0">Latest Auction NFTs</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="col-12">
              <div className="section-title text-center mb-4 pb-2">
                <h4 className="title mb-2">{t("popularCollection")}</h4>
      ...
      <div className="container">
        <div className="row align-items-end mb-4 pb-2">
          <div className="col-md-8">
            <div className="section-title">
              <h4 className="title mb-2">{t("topCollection")}</h4>
              <p className="text-muted mb-0">{t("bestCollectionOfWeek")}</p>
            </div>
          </div>
